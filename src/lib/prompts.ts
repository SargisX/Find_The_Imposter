...
export class PromptEngine {
  private static readonly LANGUAGE_CONFIGS = {
    ...
    ru: {
      name: "Русский",
      culturalNote:
        "Используй общеизвестные слова и понятия, знакомые русскоязычной аудитории.",
      examples: {
        animals: {
          word: "слон",
          hints: ["память", "цирк", "большой"],
        },
        food: {
          word: "пицца",
          hints: ["доставка", "треугольник", "сыр"],
        },
        objects: {
          word: "молоток",
          hints: ["судья", "гром", "строительство"],
        },
        places: {
          word: "библиотека",
          hints: ["тишина", "книги", "учёба"],
        },
        professions: {
          word: "повар",
          hints: ["температура", "творчество", "кухня"],
        },
      },
    },
  };
